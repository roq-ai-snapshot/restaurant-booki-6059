...
import { useRoqPlatformUserProfiles, useMenuCount, useOrderCount, useTableReservationCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const tableReservationStat = useTableReservationCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    },
    {
      ...
      result: tableReservationStat?.data,
      isLoading: tableReservationStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },
